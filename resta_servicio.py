...
# --- Configuración ---
MY_SERVICE_NAME = "resta"  # Nombre de este servicio (5 caracteres)
...
MY_LISTEN_PORT = 5002    # Puerto donde ESTE servicio "resta" escuchará
    ...
    try:
        while True:
            ...
            if req_service_id == MY_SERVICE_NAME:
                ...
                if largo_str == "00011" and req_service_id == "resta" and req_payload_data == "HOLAS1":
                    response_message_str = "00012restaPRUEBA1RESTA" # Respuesta específica para resta
